...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-domain-management': RouteRecordInfo<'admin-domain-management', '/admin/domain-management', Record<never, never>, Record<never, never>>,
    ...
    'apps-contents': RouteRecordInfo<'apps-contents', '/apps/contents', Record<never, never>, Record<never, never>>,
