...
const submitDomain = async () => {
  ...
  try {
    ...
    console.log('Base URL from axios:', import.meta.env.VITE_API_BASE_URL || '/api')
    console.log('Full URL should be:', (import.meta.env.VITE_API_BASE_URL || '/api') + '/client/set-domain')
