...
const translateMouse = computed(() => {
  if (typeof window !== 'undefined') {
    ...
    return { transform: `perspective(1200px) rotateX(${ rotateX.value < -40 ? -20 : rotateX.value }deg) rotateY(${ rotateY }deg) scale3d(1,1,1)` }
  }
...
.landing-hero-light-bg {
  background:
 url("@images/front-pages/backgrounds/hero-bg.png") center
    no-repeat,
